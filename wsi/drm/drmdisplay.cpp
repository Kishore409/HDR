...
void DrmDisplay::DrmConnectorGetHDRStaticMetadata(uint8_t *b, uint8_t length) {
    ...
    display_hdrMd = (struct drm_edid_hdr_metadata_static *)malloc(sizeof(struct drm_edid_hdr_metadata_static));
    if (!display_hdrMd) {
...
void DrmDisplay::DrmConnectorGetcolorPrimaries(uint8_t *b, struct drm_display_color_primaries *p) {
